...
#define CUST_BYTE_NUM_OUT	112//96//64//
#define CUST_BYTE_NUM_IN	84//76//84//
#define TOT_BYTE_NUM_ROUND_OUT	112//96//64//
#define TOT_BYTE_NUM_ROUND_IN	84//76//84//
...
#define FST_BYTE_NUM_ROUND_IN  64                 // number of bytes of the first transfer
                                                  // rounded to 4 (long)
#define FST_LONG_NUM_IN  20//12//20                       // number of long of the second transfer
...
#define FST_BYTE_NUM_ROUND_OUT  64                 // number of bytes of the first transfer
                                                  // rounded to 4 (long)
#define FST_LONG_NUM_OUT  48//32//20                       // number of long of the second transfer
